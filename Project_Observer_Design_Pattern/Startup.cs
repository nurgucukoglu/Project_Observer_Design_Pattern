    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<UserObserverSubject>(sp =>
            {
                ...
                //her bir sýnýfý subjecte kaydedeceðim.
                userObserverSubject.RegisterObserver(new UserObserverWriteToConsole(sp));//her bir observer sýnýfýný kaydedecek
                ...
                //tüm tanýmladýðým sýnýflarý burada çaðýrýyorum
                return userObserverSubject;
            });//observer'la ilgili ana metotlarýmýn olduðu sýnýfý alýr.
